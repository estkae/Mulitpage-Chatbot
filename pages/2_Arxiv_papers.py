...
st.sidebar.write(" [Arxiv Papers](https://arxiv.org/)is an open-source data created by the University of Cornell 🎓 that provides access to a wide range of research papers 📝. Our platform specializes in artificial intelligence ,  natural language processing , prompt engineering, and energy-related papers ⚡.")
...
with col2:
    option_expert = st.selectbox(
        'What is the level of Expertise of summary you like?',
...
llm=Cohere(model="command-xlarge-nightly", cohere_api_key="vGCEakgncpouo9Nz0rsJ0Bq7XRvwNgTCZMKSohlg",temperature=0.7)
